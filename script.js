...
const updateTotals = () => {
  ...
  document.getElementById("expense-total").textContent = expenseSum.toFixed(2);
  document.getElementById("income-total").textContent = incomeSum.toFixed(2);
  document.getElementById("balance-total").textContent = totalBalance.toFixed(2);
};
